    ...
    <div >
        <nav class="navbar navbar-inverse custom-header">
            <div class="container-fluid">
                <div class="navbar-header"><a class="navbar-brand navbar-link" href="index.php"><strong>Techno Kryon</strong></a>
                    <button class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
                </div>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                        <ul class="nav navbar-nav links">
                                <li role="presentation"><a href="index.php">Home </a></li>
                                <li role="presentation"><a href="gamecategories.php">Game categories</a></li>
                                <li role="presentation"><a href="news&events.php">News and Events</a></li>
                                <?php 
                                if(strlen($_SESSION['userlogin'])>0){?>
                                <li role="presentation"><a href="./shoppiggifts.php" class="custom-navbar"> Shopping Gifts<span class="badge">new</span></a></li>
                                <?php } ?>
                        </ul>    
                            <?php maindiv();?>
                </div>
